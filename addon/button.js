...
// Flow Builder: display colored banner if setting is enabled
chrome.storage.local.get("showFlowBuilderBanner", ({showFlowBuilderBanner}) => {
  const show = JSON.parse(showFlowBuilderBanner || "false");
  if (show) {
    const style = document.createElement("style");
    // Placeholder CSS for colored banner on Flow Builder page
    style.textContent = ".builder_platform_interaction-container-common { border-top: 4px solid #0070d2 !important; }";
